...
echo "==> 2. Setting up Serial / Hardware permissions..."
...
echo "==> 5. Setting up Starship prompt & Shell Aliases..."
...
echo "==> 6. Setting up Alacritty (Tokyo Night Theme)..."
...
echo "==> 7. Configuring GNOME Theme & Wallpaper..."
if command -v gsettings &> /dev/null; then
    ...
    # Download directly from your dotfiles root
    curl -sSLo "$WALLPAPER_PATH" "https://raw.githubusercontent.com/thareekh/dotfiles/main/wallpaper.jpg" || true
